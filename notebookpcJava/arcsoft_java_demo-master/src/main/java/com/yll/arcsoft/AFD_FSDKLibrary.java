...
public interface AFD_FSDKLibrary extends Library {
    ...
    AFD_FSDKLibrary INSTANCE = (AFD_FSDKLibrary)Native.loadLibrary(Platform.isWindows()?"libarcsoft_fsdk_face_detection.dll":"libarcsoft_fsdk_face_detection.so",AFD_FSDKLibrary.class);
